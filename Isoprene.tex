...
%% several \usepackage commands are included in the copernicus.cls
%% -----------------------------------------
%% packages added by me
%% ----------------------------------------
\usepackage{threeparttable}
\usepackage{booktabs} % adds \toprule \midrule \bottomrule
\usepackage{xcolor} % xcolor has more colours than package{color} but doesn't work?
...
\Author[1]{Jenny}{Fisher}
%\Author[]{}{}

\affil[1]{University of Wollongong, Australia}
%\affil[]{ADDRESS}
